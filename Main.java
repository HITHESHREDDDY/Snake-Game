...
class Snake {
    ...
    public void move() {
        ...
        newTail.add(new Point(head));
        for (int i = 0; i < tail.size() - 1; i++) {
            newTail.add(new Point(tail.get(i)));
        }
        tail = newTail;
    ...
    public void turn(Direction newDirection) {
        if ((direction.isX() && newDirection.isY()) || (direction.isY() && newDirection.isX())) {
